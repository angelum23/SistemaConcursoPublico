...
namespace SistemaConcurso.PgRepository.Migrations
{
    ...
    [Migration("20251002183520_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SistemaConcurso.Domain.Entities.LessonAssessment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("SistemaConcurso.Domain.Entities.ModuleAssessment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("SistemaConcurso.Domain.Entities.Questions", b =>
                {
                    ...
                    b.Property<int?>("LessonAssessmentId")
                        .HasColumnType("integer")
                        .HasColumnName("lessonassessmentid");

                    b.Property<int?>("ModuleAssessmentId")
                        .HasColumnType("integer")
                        .HasColumnName("moduleassessmentid");
                    ...
                    b.Property<int?>("RoadmapAssessmentId")
                        .HasColumnType("integer")
                        .HasColumnName("roadmapassessmentid");
                    ...
                    b.HasIndex("LessonAssessmentId");

                    b.HasIndex("ModuleAssessmentId");

                    b.HasIndex("RoadmapAssessmentId");
            ...
            modelBuilder.Entity("SistemaConcurso.Domain.Entities.RoadmapAssessment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("SistemaConcurso.Domain.Entities.Roadmaps", b =>
                {
                    ...
                    b.Property<int?>("SelectedJobRoleId")
                        .HasColumnType("integer")
                        .HasColumnName("selectedjobroleid");
            ...
            modelBuilder.Entity("SistemaConcurso.Domain.Entities.Questions", b =>
                {
                    b.HasOne("SistemaConcurso.Domain.Entities.LessonAssessment", "LessonAssessment")
                        .WithMany("Questions")
                        .HasForeignKey("LessonAssessmentId");

                    b.HasOne("SistemaConcurso.Domain.Entities.ModuleAssessment", "ModuleAssessment")
                        .WithMany("Questions")
                        .HasForeignKey("ModuleAssessmentId");

                    b.HasOne("SistemaConcurso.Domain.Entities.RoadmapAssessment", "RoadmapAssessment")
                        .WithMany("Questions")
                        .HasForeignKey("RoadmapAssessmentId");
            ...
            modelBuilder.Entity("SistemaConcurso.Domain.Entities.Roadmaps", b =>
                {
                    ...
                    b.HasOne("SistemaConcurso.Domain.Entities.JobRoles", "SelectedJobRole")
                        .WithMany()
                        .HasForeignKey("SelectedJobRoleId");
